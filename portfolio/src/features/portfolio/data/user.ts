...
export const USER: User = {
  ...
  gender: "male",
  pronouns: "he/him",
  bio: "AI engineer. I build the backend systems that power real AI products.",
  flipSentences: [
    "AI engineer, focused on the application side",
    "I build the backend behind AI products",
    "I turn AI models into shipped features",
    "I make AI apps work in production",
    "The systems that run intelligent products",
  ],
  address: "India",
